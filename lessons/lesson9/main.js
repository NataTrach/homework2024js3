...
const liMas = ['Main','Products','About us','Contacts'];
const body2 = document.querySelector('body');
const ul = document.createElement('ul');

for (const item of liMas) {
...
for (const simpson of simpsons) {
    ...
    div.append(h1,h5,p,img);
    body5.appendChild(div);
}
...
for (const item of coursesArray) {
   ...
   month.innerText = `Month: ${item.monthDuration}`;
   hour.innerText = `Hour: ${item.hourDuration}`;
    for (const module of item.modules) {
        const li = document.createElement('li');
        li.innerText = module;
        li.classList.add('red','list')
        ul.appendChild(li);
    }
    block.classList.add('main');
    title.classList.add('text-center','red');
    duration.classList.add('flex');
    month.classList.add('red','text-center','grow');
    hour.classList.add('red','text-center','grow1');
    ul.classList.add('red','margin');
